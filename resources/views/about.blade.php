    ...
    <div class="flex flex-col px-8 mx-auto space-y-12 max-w-7xl xl:px-12">
        ...
        <div class="flex flex-col mb-8 animated fadeIn sm:flex-row">
            ...
            <div class="flex flex-col justify-center mt-5 mb-8 md:mt-0 sm:w-1/2 md:w-7/12 sm:pr-16">
                <p class="mb-2 text-sm font-semibold leading-none text-left uppercase text-green-400" data-primary="indigo-600">A-level Computer Science Project<br></p>
        ...
        <div class="flex flex-col mb-8 animated fadeIn sm:flex-row">
            ...
            <div class="flex flex-col justify-center mt-5 mb-8 md:mt-0 sm:w-1/2 md:w-7/12 sm:pl-16">
                <p class="mb-2 text-sm font-semibold leading-none text-left uppercase text-green-400" data-primary="indigo-600">Landing a Job at Visualsoft<br></p>
        ...
        <div class="flex flex-col mb-8 animated fadeIn sm:flex-row">
            ...
            <div class="flex flex-col justify-center mt-5 mb-8 md:mt-0 sm:w-1/2 md:w-7/12 sm:pr-16">
                <p class="mb-2 text-sm font-semibold leading-none text-left uppercase text-green-400" data-primary="indigo-600">Going Freelance<br></p>
