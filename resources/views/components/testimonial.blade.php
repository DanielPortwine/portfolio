...
{{--            <p class="text-base leading-relaxed md:text-lg">{{ $testimonial['testimonial'] }}</p>--}}
{{--            <span class="inline-block w-10 h-1 mt-8 mb-6 bg-green-500 rounded" data-primary="green-500"></span>--}}
