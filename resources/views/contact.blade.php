...
<div class="py-10 bg-gray-700 md:py-16">
    <div class="px-10 mx-auto max-w-7xl md:px-16">
        ...
        <form class="grid max-w-3xl gap-4 mx-auto sm:grid-cols-2" method="post" action="{{ route('contact-send') }}">
            @csrf
            <div class="">
                ...
                <input name="first-name" class="w-full px-3 py-2 text-gray-800 transition duration-100 border rounded-md outline-none bg-gray-50 focus:ring ring-blue-300" maxlength="25" required>
            </div>
            <div class="">
            ...
            <div class="sm:col-span-2">
                ...
                <input name="email" class="w-full px-3 py-2 text-gray-800 transition duration-100 border rounded-md outline-none bg-gray-50 focus:ring ring-blue-300" maxlength="150" required>
            </div>
            <div class="sm:col-span-2">
